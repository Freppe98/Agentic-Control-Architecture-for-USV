...
// navigable; points to the classic dashboard for full functionality meanwhile.
...
export function Stub(root, key) {
  ...
  root.innerHTML =
    ...
    `<div class="stub">
       ...
       <p>This page is next in the migration queue. The design is frozen in the approved wireframe; it will appear here once wired to the live backend. The <a href="/">classic dashboard</a> remains available in the meantime.</p>
     </div>`;
