...
The main layers are low level control (Pixhawk 6C ONBOARD), agent and main apps (Raspberry Pi 5 ONBOARD), global server / operator (Computer/laptop OFFBOARD). Information is gathered by the agent from other layers to reason and then send back appropriate information.
